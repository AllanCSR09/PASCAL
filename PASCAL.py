...
def principal():
    ...
    def info_PRINCIPAL():
        ...
        titulo = Label(
            help_PRINCIPAL,
            text="Información del Menú Principal",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
            fg=Letras.get(),
        )
        titulo.grid(row=0, column=0, columnspan=2, sticky="ew")

        informacion_PRINCIPAL = Text(
            help_PRINCIPAL,
            width=500,
            wrap=WORD,
            fg=tema_Secundario.get(),
            bg=tema_Principal.get(),
        )
    ...
    global status_bar
    status_bar = Label(
        frm_barra, text="", font=("TkDefaultFont", 10, "bold"), anchor=W, fg="#003366"
    )
    ...
    information = Button(
        frm_barra, image=img_INFORMA, borderwidth=0, command=info_PRINCIPAL
    )
    ...
    plantas = Button(
        frm_principal, image=img_plantas, height=250, width=250, command=experiments
    )
    ...
    configuracion = Button(
        frm_principal, image=img_config, height=250, width=250, command=config
    )
...
def config():
    ...
    def info_CONFIG():
        ...
        titulo = Label(
            help_CONFIG,
            text="Información de la Pantalla de Configuración",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
        )
        titulo.grid(row=0, column=0, columnspan=2, sticky="ew")
    ...
    information = Button(
        frm_barra, image=img_INFORMA, borderwidth=0, command=info_CONFIG
    )
    information.grid(row=0, column=4, sticky=tk.E, padx=10)
    information.bind("<Enter>", inButtonInformation)
    information.bind("<Leave>", outButton)
    ...
    resolucion1085x655 = Radiobutton(
        lbfrm_resolucion,
        text="1085x655",
        variable=Resolucion,
        value="1085x655",
    ...
    resolucion1366x768 = Radiobutton(
        lbfrm_resolucion,
        text="1366x768",
        variable=Resolucion,
        value="1366x768",
    ...
    resolucion1920x1080 = Radiobutton(
        lbfrm_resolucion,
        text="1920x1080",
        variable=Resolucion,
        value="1920x1080",
    ...
    aplicarresolucion = Button(
        lbfrm_resolucion,
        text="Aplicar",
        font=("TkDefaultFont", 15),
        fg=tema_Principal.get(),
        bg=tema_Secundario.get(),
        command=lambda: cambiar_resolucion(Resolucion.get()),
    )
    aplicarresolucion.grid(row=0, column=4, padx=25, sticky="E")

    lbfrm_tema = LabelFrame(
        frm_config,
        text="Tema",
        padx=25,
        pady=25,
    ...
    aplicartema = Button(
        ...
        text="Aplicar",
        font=("TkDefaultFont", 15),
        command=lambda: cambiar_tema(theme.get()),
        fg=tema_Principal.get(),
        bg=tema_Secundario.get(),
    )
    aplicartema.grid(row=0, column=2, sticky="E", padx=25)

    lbfrm_comm = LabelFrame(
        frm_config,
        text="Puertos de comunicación",
        padx=25,
        pady=25,
        font=("TkDefaultFont", 15, "bold"),
        bg=tema_Principal.get(),
...
def experiments():
    ...
    def info_EXPERIMENTS():
        ...
        titulo = Label(
            help_EXPERIMENTS,
            text="Información de la Pantalla de selección de experimentos",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
            fg=Letras.get(),
        )
    ...
    def systeminfo(planta):
        ...
        if planta == "HELI2DOF":
            ...
            titulo = Label(
                info,
                text="Helicóptero con dos grados de libertad",
                font=("TkDefaultFont", 15),
                bg=tema_Secundario.get(),
                fg=Letras.get(),
            )
        ...
        if planta == "PAMH":
            ...
            titulo = Label(
                info,
                text="Péndulo amortiguado a hélice",
                font=("TkDefaultFont", 15),
                bg=tema_Secundario.get(),
                fg=Letras.get(),
            )
    ...
    mensaje = Label(
        frm_experimentos,
        text="Pantalla de selección de experimento",
        font=("TkDefaultFont", 15),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    # Botones de la barra de Menú
    back = Button(
        frm_barra, image=img_ATRAS, borderwidth=0, command=experimentstoprincipal
    )
    back.grid(row=0, column=1, sticky=tk.E, padx=10)
    back.bind("<Enter>", inButtonBack)
    back.bind("<Leave>", outButton)
    ...
    information = Button(
        frm_barra, image=img_INFORMA, borderwidth=0, command=info_EXPERIMENTS
    )
    information.grid(row=0, column=4, sticky=tk.E, padx=10)
    information.bind("<Enter>", inButtonInformation)
    information.bind("<Leave>", outButton)
    ...
    heli_pic = Button(
        frm_experimentos, image=img_heli, command=lambda: systeminfo("HELI2DOF")
    )
    heli_pic.grid(row=2, column=0)
    ...
    heli_exp = Button(
        ...
        command=lambda: systeminfo("HELI2DOF"),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    pamh_pic = Button(
        frm_experimentos, image=img_pamh, command=lambda: systeminfo("PAMH")
    )
    pamh_pic.grid(row=2, column=1)
    ...
    pamh_exp = Button(
        ...
        text="PAMH",
        font=("TkDefaultFont", 10, "bold"),
        command=lambda: systeminfo("PAMH"),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    bb_pic = Button(
        frm_experimentos, image=img_bb, command=lambda: systeminfo("BALL&BEAM")
    )
    bb_pic.grid(row=2, column=2)
    ...
    bb_exp = Button(
        ...
        text="Ball&Beam",
        font=("TkDefaultFont", 10, "bold"),
        command=lambda: systeminfo("BALL&BEAM"),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    grua_pic = Button(
        frm_experimentos, image=img_grua, command=lambda: systeminfo("GRUA")
    )
    grua_pic.grid(row=2, column=3)
    ...
    grua_exp = Button(
        ...
        text="Grúa",
        font=("TkDefaultFont", 10, "bold"),
        command=lambda: systeminfo("GRUA"),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    motor_pic = Button(
        frm_experimentos, image=img_motor, command=lambda: systeminfo("MOTORCD")
    )
    motor_pic.grid(row=4, column=0)
    ...
    motor_exp = Button(
        ...
        text="Motor CD",
        font=("TkDefaultFont", 10, "bold"),
        command=lambda: systeminfo("MOTORCD"),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    otro_pic = Button(
        frm_experimentos, image=img_otro, command=lambda: systeminfo("Otro")
    )
    otro_pic.grid(row=4, column=1)
    ...
    otro_exp = Button(
        ...
        text="Otro",
        font=("TkDefaultFont", 10, "bold"),
        command=lambda: systeminfo("Otro"),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
...
def estructura():
    ...
    def guardarArchivo(event, opcion=False):
        ...
        if directorio == "Laboratorio de Control Automático - Archivo Nuevo":
            nuevoDirectorio = filedialog.asksaveasfilename(
                initialfile="Untitled-1", defaultextension=".xml"
            )
        else:
    ...
    def cerrarAplicacion():
        ...
        if cambiosArchivo is True:
            opcion = messagebox.askyesnocancel(
                "Laboratorio de Control Automático | TEC", "¿Desea guardar los cambios?"
            )
            if opcion is True:
    ...
    def abrirDesdeSystem():
        global directorio
        global trigger
        nuevoDirectorio = filedialog.askopenfilename(
            initialdir=ruta, filetypes=[("XML", "*.xml")]
        )
    ...
    def configuracionArchivo(event):
        ...
        if ventanaCerrada:
            ...
            Label(
                frame2, text="Comunicación Serie", font=("Arial Rounded MT Bold", -18)
            ...
            Label(frame2, text="Puerto:").grid(
                row=1, column=0, sticky=W, padx=(20, 0), pady=(0, 0)
            )
            ttk.Entry(frame2, width=30, textvariable=nombre_dispositivo).grid(
                row=1, column=1, sticky=W, padx=(0, 20), pady=(0, 0)
            )

            Label(frame2, text="Velocidad:").grid(
                row=2, column=0, sticky=W, padx=(20, 0), pady=(0, 0)
            )
            ttk.Entry(frame2, width=30, textvariable=velocidad).grid(
                row=2, column=1, sticky=W, padx=(0, 20), pady=(0, 0)
            )

            Label(frame2, text="Simulación", font=("Arial Rounded MT Bold", -18)).grid(
                row=3, column=0, sticky=W, columnspan=2, padx=10, pady=10
            )

            Label(frame2, text="Tiempo de muestreo (ms):").grid(
                row=4, column=0, sticky=W, padx=(20, 0), pady=(0, 0)
            )
            ttk.Entry(frame2, width=30, textvariable=tiempoMuestreo).grid(
                row=4, column=1, sticky=W, padx=(0, 20), pady=(0, 0)
            )

            Label(frame2, text="Número de muestras:").grid(
                row=5, column=0, sticky=W, padx=(20, 0), pady=(0, 20)
            )
            ttk.Entry(frame2, width=30, textvariable=numeroMuestras).grid(
                row=5, column=1, sticky=W, padx=(0, 20), pady=(0, 20)
            )
            ...
            ttk.Button(
                frame3,
                text="Aceptar",
                command=lambda: cerrarVentanaConfiguracion("Aceptar"),
            ).pack(side=RIGHT, padx=(10, 20), pady=(0, 10))
            ttk.Button(
                frame3,
                text="Cancelar",
                command=lambda: cerrarVentanaConfiguracion("Cancelar"),
    ...
    def coordenadasIcono(event, icono):
        ...
        if icono == "ADC":
            imagen = PhotoImage(file="ADCn.png")
        if icono == "PID":
            imagen = PhotoImage(file="PIDn.png")
        if icono == "PWM":
            imagen = PhotoImage(file="PWMn.png")
        if icono == "RE":
            imagen = PhotoImage(file="REn.png")
        if icono == "CTE":
            imagen = PhotoImage(file="CTEn.png")
        if icono == "FT":
            imagen = PhotoImage(file="FTn.png")
        if icono == "SAT":
            imagen = PhotoImage(file="SATn.png")
        if icono == "QDEC":
            imagen = PhotoImage(file="QDECn.png")
        if icono == "DAC":
            imagen = PhotoImage(file="DACn.png")
        if icono == "FLT":
            imagen = PhotoImage(file="FLTn.png")
        if icono == "DER":
            imagen = PhotoImage(file="DERn.png")
        if icono == "SUM":
            imagen = PhotoImage(file="SUMn.png")
        if icono == "REST":
            imagen = PhotoImage(file="RESTn.png")
        if icono == "SCOPE":
            imagen = PhotoImage(file="SCOPEn.png")
        if icono == "STEP":
            imagen = PhotoImage(file="STEPn.png")
        if icono == "TRAPECIO":
            imagen = PhotoImage(file="TRAPECIOn.png")
        if icono == "SALP":
    ...
    def nuevoModulo(event, lista):
        ...
        if (
            tamano_ventana_x > coordenada_x > 20
            and tamano_ventana_y > coordenada_y > 20
        ):
            cambiosArchivo = True
    ...
    def cambiarIconos(event):
        ...
        if pagina:
            ...
            icon_1.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_SCOPE)
            )
            ...
            icon_2.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_STEP)
            )
            ...
            icon_3.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_TRAPECIO)
            )
            ...
            icon_4.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_DER)
            )
            ...
            icon_5.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_SUM)
            )
        ...
        if not pagina:
            ...
            icon_1.bind("<B1-Motion>", arrastrarIcono)
            icon_1.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_ADC)
            )
            ...
            icon_2.bind("<B1-Motion>", arrastrarIcono)
            icon_2.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_PID)
            )
            ...
            icon_3.bind("<B1-Motion>", arrastrarIcono)
            icon_3.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_PWM)
            )
            ...
            icon_5.bind("<B1-Motion>", arrastrarIcono)
            icon_5.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_CTE)
            )
            ...
            icon_7.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_SAT)
            )
            ...
            icon_8.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_QDEC)
            )
            ...
            icon_9.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_DAC)
            )
            ...
            icon_10.bind(
                "<ButtonRelease-1>", lambda event: nuevoModulo(event, lista_FLT)
            )
    ...
    def comunicacion(event):
        ...
        confirmacion = askyesno(
            ...
            message="La estructura de experimento está a punto de transmitirse. Asegúrese de que la planta se encuentra en reposo antes de proceder.\n¿Desea continuar?",
        )
        if confirmacion:
            if estadoBorrar:
                cancelar_Borrar(None)
            ...
            if lista_Linea.tamano() > 0:
                ...
                try:
                    ...
                    with open(archivo) as fp:
                        ...
                        messagebox.showinfo(
                            "", "La transmisión de datos ha sido exitosa"
                        )
                        expProgreso()
    ...
    def info_STRUCT():
        ...
        titulo = Label(
            help_STRUCT,
            text="Información de la Pantalla de estructura de experimento",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
        )
        titulo.grid(row=0, column=0, columnspan=2, sticky="ew")
    ...
    mensaje = Label(
        frm_estructura,
        text="Pantalla de Estructura de Experimento",
        font=("TkDefaultFont", 15),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    status_bar = Label(
        frm_barra,
        text="Laboratorio de Control Automático - Archivo Nuevo",
        font=("TkDefaultFont", 10, "bold"),
        anchor=W,
        fg="#003366",
    )
    ...
    # Botones de la barra de Menú
    back = Button(
        frm_barra, image=img_ATRAS, borderwidth=0, command=estructuratoexperimentos
    )
    back.grid(row=0, column=1, sticky=tk.E, padx=10)
    back.bind("<Enter>", inButtonBack)
    ...
    # Verificar si el botón de deshacer tiene una acción asociada
    if revert["command"]:
        print("El botón de deshacer tiene una acción asociada.")
    else:
        print("El botón de deshacer no tiene ninguna acción asociada.")
    ...
    information = Button(
        frm_barra, image=img_INFORMA, borderwidth=0, command=info_STRUCT
    )
    information.grid(row=0, column=4, sticky=tk.E, padx=10)
    information.bind("<Enter>", inButtonInformation)
    ...
    icon_Configuracion = Label(
        frame1,
        image=imagen_Configuracion,
        borderwidth=0,
        highlightthickness=0,
        bg="#2C2C2C",
        padx=0,
    ...
    # Texto Módulos
    Label(
        frame2, text="Módulos", bg="#2C2C2C", fg="White", font=("Arial Rounded MT", -20)
    ).pack(side=LEFT, padx=13)

    # Icono Flechas Modulos (cambiar Pagina)
    imagen_Flechas_Modulos = PhotoImage(file="Flecha_Modulos.png")
    imagen_Flechas_Modulos_Label = Label(
        frame2,
        image=imagen_Flechas_Modulos,
        borderwidth=0,
        highlightthickness=0,
        bg="#2C2C2C",
        padx=0,
    ...
    imagen_Barra2_Label = Label(
        sideBar, image=imagen_Barra, borderwidth=0, highlightthickness=0, padx=0, pady=0
    )
...
def expProgreso():
        ...
        while True:
            if transmision == True:
                for j in range(10):
                    ...
                    squareON = Label(
                        frm_progressBar, bg=tema_Secundario.get(), width=2, height=1
                    )
                    ...
                    squareOFF = Label(
                        frm_progressBar, bg=Letras.get(), width=2, height=1
                    )
    ...
    def executing():
        ...
        confirmacion = askyesno(
            title="Ventana de confirmación",
            message="¿Desea comenzar la ejecución del experimento?",
        )
        if confirmacion:
    ...
    def recibirDatos():
        ...
        dispositivo.write(
            trama.strip().encode()
        )  # Se escribe "R" en el dispositivo (comienza experimento)
        while True:
            if transmision:
    ...
    def ver_Enviados():
        ...
        titulo = Label(
            ventanaEnviados,
            text="Ventana de datos enviados",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
            fg=Letras.get(),
        )
    ...
    def info_INPROGRESS():
        ...
        titulo = Label(
            help_INPROGRESS,
            text="Información de la Pantalla de experimento en progreso",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
            fg=Letras.get(),
        )
    ...
    def progressToStructure():
        salir = askyesno(
            title="Ventana de confirmación",
            message="El experimento será cancelado. ¿Esta seguro que desea regresar?",
        )
        if salir:
            root.deiconify()
            branch.destroy()
    ...
    def endSalir():
        salir = askyesno(
            title="Ventana de confirmación",
            message="El experimento será cancelado. ¿Esta seguro que desea salir de PASCAL?",
        )
        if salir:
            root.destroy()
            branch.destroy()
    ...
    branch.title(
        "Plataforma acelerada de sistemas de control automático en laboratorio"
    )
    ...
    mensaje = Label(
        frm_ejecutando,
        text="Pantalla de experimento en progreso",
        font=("TkDefaultFont", 15),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    # Botones de la barra de Menú
    back2 = Button(
        frm_barra, image=img_ATRAS, borderwidth=0, command=progressToStructure
    )
    ...
    information2 = Button(
        frm_barra, image=img_INFORMA, borderwidth=0, command=info_INPROGRESS
    )
    ...
    global frm_progressBar
    frm_progressBar = Frame(
        frm_commpic, bg=tema_Principal.get()
    )  # width=200, height=300, bg=tema_Principal.get())
    ...
    btn_datosEnviados = Button(
        frm_data,
        image=img_ENVIADOS,
        bg=tema_Principal.get(),
        borderwidth=0,
        command=ver_Enviados,
    )
    btn_datosEnviados.grid(row=0, column=0, pady=25)

    btn_datosRecibidos = Button(
        frm_data,
        image=img_RECIBIDOS,
        bg=tema_Principal.get(),
        borderwidth=0,
        command=ver_Recibidos,
    )
    btn_datosRecibidos.grid(row=1, column=0)

    frm_graph = Frame(
        frm_ejecutando, width=300, height=300
    )  # LabelFrame(frm_ejecutando, text="Gráfico", width=300, height=300)
    ...
    titulo = Label(
        ventanaRecibidos,
        text="Ventana de datos capturados",
        font=("TkDefaultFont", 15),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
...
def expFinalizado():
    ...
    def export_CSV():
        ...
        path = filedialog.asksaveasfilename(
            initialfile="Untitled-1", defaultextension=".csv"
        )
    ...
    def finalSalir():
        salir = askyesno(
            title="Ventana de confirmación",
            message="Los datos del experimento se perderán si no se han guardado. ¿Esta seguro que desea salir de la Pantalla de experimento finalizado?",
        )
        if salir:
            root.deiconify()
            branch.destroy()
    ...
    def endSalir():
        salir = askyesno(
            title="Ventana de confirmación",
            message="Los datos del experimento se perderán si no se han guardado. ¿Esta seguro que desea salir de PASCAL?",
        )
        if salir:
            branch.destroy()
            root.destroy()
    ...
    def info_END():
        ...
        titulo = Label(
            help_END,
            text="Información de la Pantalla de experimento finalizado",
            font=("TkDefaultFont", 15),
            bg=tema_Secundario.get(),
        )
        titulo.grid(row=0, column=0, columnspan=2, sticky="ew")
    ...
    mensaje = Label(
        frm_fin,
        text="Pantalla de experimento finalizado",
        font=("TkDefaultFont", 15),
        bg=tema_Secundario.get(),
        fg=Letras.get(),
    )
    ...
    running2 = Button(
        frm_barra, image=img_RUN, borderwidth=0, state=DISABLED
    )  # , command=threading.Thread(target=executing).start())
    running2.grid(row=0, column=8, sticky=tk.E, padx=10)
    running2.bind("<Enter>", inButtonRun2)
    running2.bind("<Leave>", outButton2)

    stopping2 = Button(
        frm_barra, image=img_STOP, borderwidth=0, state=DISABLED
    )  # , command=threading.Thread(target=stop).start())
    stopping2.grid(row=0, column=9, sticky=tk.E, padx=10)
    stopping2.bind("<Enter>", inButtonStop2)
    stopping2.bind("<Leave>", outButton2)
    ...
    while True:
        ...
        if linea[0] == ",":
            ...
            vectorlineastr[len(vectorlineastr) - 1] = vectorlineastr[
                len(vectorlineastr) - 1
            ].replace("\n", "")
            if encabezado:
    ...
    button_Exit = Button(
        frm_variables,
        text="Estructura de experimento",
        font=("TkDefaultFont", 10, "bold"),
        bg=tema_Principal.get(),
        fg=tema_Secundario.get(),
        command=finalSalir,
